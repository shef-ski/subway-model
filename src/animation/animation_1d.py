...
def animate_simulation_1d(
    ...
    ax.plot(
        [s.id for s in line.get_stations()],
        [0] * len(line.get_stations()),
        "-o",
        color="grey",
        markersize=8,
        label="Line",
